#
# BlackBox Audio Files
#

ALARM_PATH := vendor/blackbox/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/blackbox/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/blackbox/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/blackbox/prebuilt/common/media/audio/ui
